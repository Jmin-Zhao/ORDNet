...
class RHD(nn.Module):
    def __init__(self, expand_planes: int):
        ...
        self.conv2 = nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=3, dilation=3)
        self.bn2 =nn.BatchNorm2d(expand_planes)
        self.relu2 = nn.ReLU(inplace=True)

        self.conv3 = nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=5, dilation=5)
        ...
        self.conv5 =nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=3, dilation=3)
        self.bn5 =nn.BatchNorm2d(expand_planes)
        self.relu5 = nn.ReLU(inplace=True)

        self.conv6 =nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=5, dilation=5)
...
"""
def mobilenet_v3_rhd135(num_classes: int = 1000, reduced_tail: bool = False):
