...
class RHD(nn.Module):
    def __init__(self, expand_planes: int):
        ...
        self.conv3 = nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=9, dilation=9)
        ...
        self.conv6 =nn.Conv2d(in_channels=expand_planes, out_channels=expand_planes, kernel_size=3, stride=1, padding=9, dilation=9)
...
"""
def mobilenet_v3_rhd139(num_classes: int = 1000, reduced_tail: bool = False):
